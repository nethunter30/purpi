            ...
            {categories.map((category) => {
              ...
              return (
                <Link
                  ...
                  className="relative flex flex-col rounded-[20px] bg-[#0c0414]/80 border border-purple-950/40 hover:border-purple-500/30 overflow-hidden group transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_12px_30px_rgba(168,85,247,0.15)]"
                >
                  {/* Illustration Area */}
