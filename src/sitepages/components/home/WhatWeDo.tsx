    ...
    <section className="relative w-full py-20 flex flex-col items-center justify-center z-10 bg-black">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-5 max-w-[1200px] w-full px-6">
        {features.map((feature, index) => (
          <div
            key={index}
            className={`relative flex flex-col rounded-[20px] bg-[#12061f] overflow-hidden group transition-transform hover:-translate-y-1 duration-300 min-h-[300px] md:min-h-[320px] ${feature.span}`}
          >
            ...
            <div className="relative z-20 flex flex-col p-6 md:p-8 mt-auto">
              <h3 className="text-white text-xl md:text-2xl font-medium mb-2 tracking-tight">
                {feature.title}
              </h3>
